        ...
        <div className="headbar">
          ...
          <div className="RightHeadbar">
            ...
            <div className="resume">
              <Link className="projects__link_resume" to="https://drive.google.com/file/d/1iSMBDSYNeTNJKtSCOLiHKwSvYZy05umk/view?usp=sharing" target="_blank">RESUME</Link>
            </div>
          </div>
              ...
              <div className="dropDownContainer">
                <div className="actualDropDown">
                  ...
                  <div className="resume__container">
                    <Link to="https://drive.google.com/file/d/1iSMBDSYNeTNJKtSCOLiHKwSvYZy05umk/view?usp=sharing" target="_blank" className="dropdown_resume">RESUME</Link>
                  </div>
